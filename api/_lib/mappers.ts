import type { Member, Expense, ExpenseSplit, Settlement, PersonalExpense, Category } from '../../src/types/index.js'
...
// ---- Expenses (A=id, B=description, C=amount, D=currency, E=paid_by, F=category, G=date, H=is_recurring, I=recurrence_type, J=notes, K=created_at, L=updated_at) ----
...
// ---- PersonalExpenses (A=id, B=member_id, C=description, D=amount, E=currency, F=category, G=date, H=is_recurring, I=recurrence_type, J=notes, K=created_at) ----
